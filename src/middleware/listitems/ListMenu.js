...
function ListMenu() {
  ...
  return (
    <List sx={{fontSize: "14px"}}>
      ...
      <ListItemButton onClick={handleClickFrontDesk}  selected={selectedIndex === 2}>
        <ListItemIcon>
      ...
      <Collapse in={openFrontDesk} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 9 }}>
            ...
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Walk-in" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Check-in" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Check-out" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Room Status" />
          </ListItemButton>
        </List>
      </Collapse>
      ...
      <ListItemButton onClick={handleClickCashier}  selected={selectedIndex === 3}>
        <ListItemIcon>
      ...
      <ListItemButton onClick={handleClickProfile}  selected={selectedIndex === 4}>
        <ListItemIcon>
      ...
      <Collapse in={openProfile} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 9 }}>
            ...
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Individual" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Travel Agent" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Company" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Group" />
          </ListItemButton>
        </List>
      </Collapse>
      ...
      <Collapse in={openHouseKeeping} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 9 }}>
            ...
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Item Management" />
          </ListItemButton>
      ...
      <ListItemButton onClick={handleClickEngineer}  selected={selectedIndex === 7}>
        <ListItemIcon>
      ...
      <ListItemButton onClick={handleClickReport}  selected={selectedIndex === 8}>
        <ListItemIcon>
      ...
      <Collapse in={openReport} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 9 }}>
            ...
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Customizable" />
          </ListItemButton>
      ...
      <ListItemButton onClick={handleClickConfiguration}  selected={selectedIndex === 9}>
        <ListItemIcon>
      ...
      <ListItemButton onClick={handleClickSystemsTools}  selected={selectedIndex === 10}>
        <ListItemIcon>
      ...
      <Collapse in={openSystemsTools} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 9 }}>
            ...
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Hotel Status" />
          </ListItemButton>

          <ListItemButton sx={{ pl: 9 }}>
           
            <ListItemText  primaryTypographyProps={{ style: setFontSize }} primary="Room Rack" />
          </ListItemButton>
